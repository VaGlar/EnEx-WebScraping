...
- ενότητα **Ανάλυση**: γράφημα τάσεων MCP/ΤΑ/ΕΤΑ/TTF/Κέρδους (δείκτης 100 =
  ...
  chart χωρίς δεύτερο άξονα), scatter TTF↔Κέρδος και TTF↔(MCP+ΤΑ-ΕΤΑ) με
  γραμμή τάσης και συντελεστή συσχέτισης r, γράφημα **Breakeven TTF**
  (πραγματικό TTF vs την τιμή αερίου στην οποία μηδενίζεται το margin, με
  σκιασμένο το περιθώριο ασφαλείας), και πίνακας μέσων όρων/συσχετίσεων
  (`enex_dam/analysis.py`)
- πλήρες πλάτος σελίδας (max 1800px), responsive μέχρι κινητό
